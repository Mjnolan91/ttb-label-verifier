...
const PROPOSALS: { title: string; detail: string }[] = [
  {
    ...
    detail:
      "The Surgeon General's January 2025 advisory urges Congress to add a cancer warning to the statutory text. Only Congress can amend it (27 U.S.C. 215 / 27 CFR 16.21) — no bill has passed, so the warning text is unchanged.",
  },
  {
