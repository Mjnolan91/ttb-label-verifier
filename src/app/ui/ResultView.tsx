...
import { toneForStatus, TONE_TINT, TONE_ICON, VERDICT_LABEL, FIELD_LABEL } from "./status";

/**
 * ResultView — the at-a-glance label-vs-application verdict (the spec's core: "Brand matches? ABV
 * correct? Government warning there?"). Each core check is a claimed-vs-extracted card; the headline
 * reduces them (gated on per-type completeness) to Approve / Needs review / Reject.
 *
...
function FieldCard({ field, index }: { field: VerifyField; index: number }) {
